...
- Terminal minimize/restore toggle for collapsing terminal panels
- Close-tab confirmation dialog to prevent accidental session loss
...
- Redesigned README for improved scannability
- Switched CI to tag-based releases, removed release branch workflow

### Added

- ARM64 Linux platform documentation and installation guide
