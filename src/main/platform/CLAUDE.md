...
- **window.ts** — `getWindowConfig()` returns BrowserWindow options (macOS: hiddenInset + trafficLightPosition, Windows/Linux: hidden + titleBarOverlay with native controls)
