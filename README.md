...
|----------|-----------|----------|
| macOS (Apple Silicon) | [Lumi-0.1.6-arm64-mac.dmg](https://github.com/szigen/lumi/releases/download/v0.1.6/Lumi-0.1.6-arm64-mac.dmg) | [.zip](https://github.com/szigen/lumi/releases/download/v0.1.6/Lumi-0.1.6-arm64-mac.zip) |
| Windows | [Lumi-Setup-0.1.6-win.exe](https://github.com/szigen/lumi/releases/download/v0.1.6/Lumi-Setup-0.1.6-win.exe) | [.exe](https://github.com/szigen/lumi/releases/download/v0.1.6/Lumi-0.1.6-win.exe) |
| Linux | [Lumi-0.1.6-linux-x86_64.AppImage](https://github.com/szigen/lumi/releases/download/v0.1.6/Lumi-0.1.6-linux-x86_64.AppImage) | [.deb](https://github.com/szigen/lumi/releases/download/v0.1.6/Lumi-0.1.6-linux-amd64.deb) |
...
1. Download `Lumi-Setup-0.1.6-win.exe`
...
> **Portable:** Download `Lumi-0.1.6-win.exe` and run it directly — no installation needed. The same SmartScreen warning applies.
...
```bash
chmod +x Lumi-0.1.6-linux-x86_64.AppImage
./Lumi-0.1.6-linux-x86_64.AppImage
```

**DEB package (Debian/Ubuntu):**
```bash
sudo dpkg -i Lumi-0.1.6-linux-amd64.deb
```

> If you get a sandbox error, either run with the `--no-sandbox` flag or set the environment variable:
> ```bash
> ELECTRON_DISABLE_SANDBOX=1 ./Lumi-0.1.6-linux-x86_64.AppImage
> ```
