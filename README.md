...
> **Portable:** Download `Lumi-0.1.9-win.exe` and run it directly — no installation needed. The same SmartScreen warning applies.
...
```bash
chmod +x Lumi-0.1.9-linux-x86_64.AppImage
./Lumi-0.1.9-linux-x86_64.AppImage
```

**DEB package (Debian/Ubuntu):**
```bash
sudo dpkg -i Lumi-0.1.9-linux-amd64.deb
```
